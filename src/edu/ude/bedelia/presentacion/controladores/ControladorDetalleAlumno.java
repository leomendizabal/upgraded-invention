...
public class ControladorDetalleAlumno extends ControladorRegistrarAlumno implements Controlador.IListar<String> {

	private static final String TAG = ControladorDetalleAlumno.class.getSimpleName().concat("  %s");
	...
	public void listar(String... argumentos) {
		try {
			if (Helper.isEmpty(argumentos)) {
				...
				System.out.println("llamo fachada");
			...
			System.err.println(String.format(TAG, a.getMessage()));
