...
public final class Mensajes {
	...
	public final static String MSG_ALUMNO_YA_APROBO_ASIGNATURA  = "El alumno ya aprobó la asignatura";
	public final static String MSG_ALUMNO_YA_ESTA_INSCRIPTO_ASIGANTURA  = "El alumno ya está inscripto a esta asignatura";
	public final static String MSG_ANO_NO_COINCIDE_CON_ACTUAL  = "El año lectivo no coincide con el actual";
