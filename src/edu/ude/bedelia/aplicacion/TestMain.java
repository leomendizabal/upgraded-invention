...
public class TestMain {
	...
	public static void correrPruebas(IFachada bedelia) {
		try {
			 ...
			 * 
			 * Alumno alumno1 = new Alumno("1111111", "NombreAlumno1", "ApellidoAlumno1",
			 * "DomicilioAlumno1", "443111111", "alumno1@test.com"); Alumno becado = new
			 * Becado("2222222", "NombreBecado", "ApellidoBecado", "DomicilioBecado",
			 * "3400900", "elbecado@test.com", 10, "descuento por ser pobre");
			 * 
			 * // Requerimiento 1 System.out.println("******* Requerimiento 1 ********");
			 ...
			 * 
			 * // Requerimiento 2 System.out.println("******* Requerimiento 2 ********");
			 ...
			 * 
			 * // Requerimiento 3 System.out.println("******* Requerimiento 3 ********");
			 * alumno1.setNombre("Alumno"); bedelia.modificarAlumno((VOAlumnoCompleto)
			 * alumno1.toVO(true)); System.out.println("-> Alumno modificado con exito");
			 * 
			 * // Requerimiento 4 System.out.println("******* Requerimiento 4 ********");
			 * ArrayList<VOAsignatura> asignaturas = bedelia.listarAsignaturas(); for
			 * (VOAsignatura vo : asignaturas) {
			 * System.out.println(String.format(vo.toString())); }
			 * 
			 * // Requerimiento 5 System.out.println("******* Requerimiento 5 ********");
			 * ArrayList<VOAlumno> alumnos = bedelia.listarAlumnosApellido("Ape"); for
			 * (VOAlumno vo : alumnos) {
			 * System.out.println(String.format("Nombre Alumno %s", vo.getNombre())); }
			 * 
			 * // Requerimiento 6 System.out.println("******* Requerimiento 6 ********");
			 * VOAlumno alumnoModificado = (VOAlumnoCompleto)
			 * bedelia.listarDatosAlumno("1111111");
			 * System.out.println("-> Datos del alumno: " + alumnoModificado.toString());
			 * 
			 * // Requerimiento 7 System.out.println("******* Requerimiento 7 ********");
			 ...
			 * 
			 * // Requerimiento 8 System.out.println("******* Requerimiento 8 ********");
			 * /*bedelia.registrarResultado(alumno1.getCedula(), 12, cocina.getCodigo(),
			 * anio); bedelia.registrarResultado(alumno1.getCedula(), 10,
			 * frances.getCodigo(), anio); bedelia.registrarResultado(becado.getCedula(), 7,
			 * cocina.getCodigo(), anio);
			...
			/*
			 * System.out.println("******* Requerimiento 9 ********"); float montoRecaudado
			 * = bedelia.montoRecaudadoPorAlumno(anio, becado.getCedula());
			 * System.out.println("-> Monto recaudado: " + montoRecaudado);
			 * 
			 * System.out.println("******* Requerimiento 10 ********");
			 * 
			 * System.out.
			 * println("Para respaldar datos DESCOMENTE la linea 99 del archivo TestMain y vuelva a ejecutar"
			 * ); System.out.println(
			 ...
			 * ArrayList<VOInscripcion> escolaridad =
			 * bedelia.listarEscolaridad(alumno1.getCedula(), false);
			 * 
			 * for (VOInscripcion i : escolaridad) {
			 * System.out.println("Inscripcion: numero " + i.getNumero() + " calificacion: "
			 * + i.getCalificacion()); }
			 * 
			 * System.out.println("******* Requerimiento 11 (modo completo)********");
			 * ArrayList<VOInscripcion> escolaridadCompleta =
			 * bedelia.listarEscolaridad(alumno1.getCedula(), true);
			 * 
			 * for (VOInscripcion i : escolaridad) {
			 * System.out.println("Inscripcion: numero " + i.getNumero() + " calificacion: "
			 * + i.getCalificacion()); }
